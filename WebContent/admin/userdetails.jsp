...
<html>
	...
	<body>
	    ...
	    <div class="container personal-adaptor user-body">
	    	<c:if test="${man!=null}"><form action="<c:url value="/controller/UpDataUser" />" method="post"></c:if>
	    		<c:choose>
					<c:when test="${man!=null}">
	    				<div class="row">
							...
							<div class="col-md-3"><input type="text" class="form-control" id="username" name="username" value="${userRequested.username}"/>${usernameErr}</div>
						</div>
						<div class="row">
							<div class="col-md-4"></div>
							<div class="col-md-1"><label for="email">Email: </label></div>
							<div class="col-md-3"><input type="email" class="form-control" id="email" name="email" value="${userRequested.email}"/>${emailErr}</div>
					</c:when>
					<c:otherwise>
						<div class="row">
							<div class="col-md-4"></div>
