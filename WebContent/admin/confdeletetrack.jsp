...
<html>
	<head>
		...
		<title>Lyrics Admin - Conferma elimina canzone</title>
	...
	<body>
		...
		<div class="container empty-body">
			<div class="row text-center title-row">
				<h2>Vuoi davvero eliminare ${param.name}?</h2>
			</div>
			<div class="row text-center">
				<form action="<c:url value="/controller/AdminDeleteTrack" />" method="get">
